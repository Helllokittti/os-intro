...
![Просмотр содержимого](image/8.png){#fig:007 width=70%}
...
![Проделывание вышеописанных команд](image/9.png){#fig:009 width=70%}
...
![man mount](image/13.png){#fig:013 width=70%}
